...
train_transform = transforms.Compose([
    ...
    transforms.TenCrop(int(imsize*0.8)),
...
imshow(torchvision.utils.make_grid(images[rand_num]))
...
for i in range(epochs):
    ...
    for j, (X_train, y_train) in enumerate(train_loader):
        ...
        if (j+1) % 10 == 0:
            print(f'Epoch: {i+1} | Train Batch: {j+1}')
    ...
    trained_model_name = 'cnn3_128_epoch_' + str(i+1) + '.pt'
    torch.save(
        cnn.state_dict(), 
...
for i in range(epochs):
    ...
    test_cnn.load_state_dict(torch.load(f'trained_models/cnn3_128_epoch_{i+1}.pt'))
...
test_cnn.load_state_dict(torch.load('trained_models/cnn3_128_epoch_2.pt'))
```
